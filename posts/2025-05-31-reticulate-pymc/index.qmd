...
Overall really impressed with the state of combing R and Python together. When I started my career, there weren't a ton of options outside of doing I/O with csv's to bring them together. Now in the same process I can use a full feature Python library for probabilistic programming, and then use non-standard evaluation for data transfromation and visualization in R.
